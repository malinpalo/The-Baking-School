# The Baking School
The Baking School Website is a platform for people that are curiouse about how to bake, that never have baked, that might think that baking is difficult and boring.

The Baking School offers classes in easy and fun baking.<br> 
In a typical class the teacher gives the student an easy recipe, tools like ingridients and kitchen utensils and finally a walktrough of the recipe. Then the student gets to bake with assistance from the teacher.
...
* I want to be abel to view the website using various devices.
* I want to easily find The Baking School on Facebook, Instagram and Youtube.
 ...
 * The color scheme for this page was taken from [Coloor](https://coolors.co/palette/ffffff-b2cdbe-76a78c-e8b34d-000000).
 The color scheme was chosen after rendering the websites homepage picture in [Coloor](https://coolors.co/palette/ffffff-b2cdbe-76a78c-e8b34d-000000) to optimize the structure and the visibility for the website.
  ![color](/assets/image/readme.md/color.png)

### Typography
 * The font for this page was taken from [google fonts](https://fonts.google.com/).
   * The font Amatic SC was used throughout the website. 

### Wireframes
* I created wireframes to get an overlook of the layout of the website.
...
* Navigation
  ...
  * A navigation bar with navigation links to Home, About, Sign Up and Contact, is located to the top right of the page.
  * The navigation links takes you to the preferable section on the page.
  * The user can easily find information on the website using the navigation bar.
...
* The HomePage Section and About Section.
  ...
  * The About Section containing text information about baking and the school.
  * The user gets clear information about what the website and school are about, why they should choose The Baking School and how the school works.
![homeabout](/assets/image/readme.md/homeabout.png)

 * The Sign Up Section
   * The Sign Up Section contains a form with required fields for users to fill in, First name, Last name and E-mail.
   * The form has a submit button in the end. Users will have to fill in all fields to be able to submit.
   * The Sign up section gives users the ability to sign up for a class.
   ![sign](/assets/image/readme.md/sign.png)

 * The Contact Section
   * The Contact Section provides users with a telefon number and an e-mail address to encourage users to take contact.
   * The users can easily contact The Baking School with questions or other requirements.
   ![contact](/assets/image/readme.md/contact.png)
  
* The Footer Section
  * The Footer Section contains icons that links the users to The Baking School on social media such as Instagram,Facebook and Youtube.
...
* Features Left To Implement
  ...
  * I would like to add an image in The About section.
  * I would like to add a gallery with pictures of the teachers and baking.
...
This website was deployed to GitHub Pages using the following steps:
* Log in to GitHub
...
* HTML - No errors where found when running the website through the
...
* [Lighthouse](https://web.dev/measure/?url=https%3A%2F%2Fmalinpalo.github.io%2FThe-Baking-School%2F) was used to test for performance and accessibilty. The following scores and issues were found: [Lighthouse scores](https://googlechrome.github.io/lighthouse/viewer/).

![lighthouse](/assets/image/readme.md/lighthouse.png)
  
## Testing User Stories
* The website was checked by family and friends on different devices.
...
* The "Submit" button works perfectly and links to the homepage. 
  

## Credits
### Code Used
 * Some of the code used for the Logo, footer and navigation bar was taken from the "Loverunning" project with some changes made to fit my project.
...
### Acknowledgments
* The website was completed as a Portfolio 1 Project for the Full Stack Software Developer (e-Commerce) Diploma at the Code Institute. 
* I would like to thank friends and family, my mentor Spencer Barriball, Slack community, and everybody at the Code Institute for their help and support.
